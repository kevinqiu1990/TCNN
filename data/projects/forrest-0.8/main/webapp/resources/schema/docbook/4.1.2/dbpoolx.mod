...
<!ENTITY % issuenum1.module "INCLUDE">
<![%issuenum1.module;[
<!ENTITY % local.issuenum1.attrib "">
<!ENTITY % issuenum1.role.attrib "%role.attrib;">

<!ENTITY % issuenum1.element "INCLUDE">
<![%issuenum1.element;[
<!ELEMENT issuenum (%docinfo.char.mix;)*>
<!--end of issuenum1.element-->]]>

<!ENTITY % issuenum1.attlist "INCLUDE">
<![%issuenum1.attlist;[
<!ATTLIST issuenum
		%common.attrib;
		%issuenum1.role.attrib;
		%local.issuenum1.attrib;
>
<!--end of issuenum1.attlist-->]]>
<!--end of issuenum1.module-->]]>
...
<!ENTITY % volumenum1.module "INCLUDE">
<![%volumenum1.module;[
<!ENTITY % local.volumenum1.attrib "">
<!ENTITY % volumenum1.role.attrib "%role.attrib;">

<!ENTITY % volumenum1.element "INCLUDE">
<![%volumenum1.element;[
<!ELEMENT volumenum (%docinfo.char.mix;)*>
<!--end of volumenum1.element-->]]>

<!ENTITY % volumenum1.attlist "INCLUDE">
<![%volumenum1.attlist;[
<!ATTLIST volumenum
		%common.attrib;
		%volumenum1.role.attrib;
		%local.volumenum1.attrib;
>
<!--end of volumenum1.attlist-->]]>
<!--end of volumenum1.module-->]]>
...
<![%anchor.attlist;[
<!ATTLIST anchor
		%idreq.attrib;		%pagenum1.attrib;		%remap.attrib;
		%xreflabel.attrib;
		%revisionflag.attrib;
		%effectivity.attrib;
		%anchor.role.attrib;
